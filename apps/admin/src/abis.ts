export const FUND_ADMIN_ABI = [
    ...
    {
        inputs: [
            { name: '_continuousMintPaused', type: 'bool' },
            { name: '_buybackPaused', type: 'bool' },
            { name: '_lpSupportPaused', type: 'bool' },
            { name: '_mintSpreadBps', type: 'int256' },
        ],
        name: 'setContinuousAccrualControls',
        outputs: [],
        stateMutability: 'nonpayable',
        type: 'function',
    },
