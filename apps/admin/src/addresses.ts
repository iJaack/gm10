...
export const MAINNET = {
    ...
    tokenomicsController: parseAddress(import.meta.env.VITE_GM10_ADMIN_TOKENOMICS_CONTROLLER_ADDRESS ?? import.meta.env.VITE_GM10_TOKENOMICS_CONTROLLER_ADDRESS),
