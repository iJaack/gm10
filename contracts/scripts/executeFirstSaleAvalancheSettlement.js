/**
 * Record, settle, and architecture-finalize the first card sale after USDC has
 * arrived in the Avalanche Safe. The connected signer must be the 1/1 Safe owner.
 *
 * Required env:
 *   LEDGER_ADDRESS=0x5cA0...
 *   SETTLED_USDC_RAW=<exact Avalanche USDC amount in 6 decimals>
 *   BRIDGE_TX_HASH=0x...
...
const SALE_TX = "0x286883812a8a8c019e282b29ee79eeea440d027b5d090caaa7256e2457837a18";
const SALE_KEY_LABEL = "courtyard-sale-7-28688381";
const GROSS_USDC_RAW = 1_900_000_000n;
const COST_BASIS_USDC_RAW = 999_000_000n;
...
async function main() {
  ...
  const bridgeTx = requireBytes32("BRIDGE_TX_HASH");
  ...
  const snapshotProof = requireBytes32("MARKET_SNAPSHOT_PROOF_HASH", ethers.id(`first-sale-market-snapshot:${bridgeTx}`));
  ...
  console.log("First sale finalized through architecture-aware route.");
}
