                ...
                <div className="mx-auto max-w-[min(1440px,calc(100vw-48px))] lg:max-w-[min(1800px,calc(100vw-64px))]">
                    <div className="grid gap-10 lg:grid-cols-[1fr_1fr]">
                        ...
                        <div>
                            ...
                            <LedgerRow columns="160px 1fr" cells={[
                                <Caption className="uppercase tracking-[0.06em] text-[var(--ink-faint)]">Legacy close</Caption>,
                                <span className="v2-mono text-right text-[var(--text-primary)]">{ROUND_2_CLOSE_LEDGER.raisedLabel} finalized</span>,
                            ]} />
                        </div>
